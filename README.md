...
| lock_transaction                    | Boolean |    No      | (Default: False) Execute `LOCK` on the table being written to. Avoids serializable isolation errors when concurrent processes are writing to the same table.
